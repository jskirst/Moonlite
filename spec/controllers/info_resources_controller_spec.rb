...
describe InfoResourcesController do
	...
	before(:each) do
		...
		@regular_user_roll = Factory(:user_roll, :company => @company, :enable_administration => "f", :enable_user_creation => "f")
		...
		@path = Factory(:path, :user => @user, :company => @company, :category => @category)
