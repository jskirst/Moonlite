if !Rails.env.production?
	...
	namespace :db do
		...
		task :populate => :environment do
			...
			moonlite_company.rewards.create!(:name => "$10 iTunes Gift Card", :description => "iTunes Gift Card worth 10 Dollars.", :image_url => "http://www.google.com", :points => 500)
			moonlite_company.rewards.create!(:name => "$20 Amazon Gift Card", :description => "Amazon Gift Card worth 20 Dollars.", :image_url => "http://www.google.com", :points => 1000)
			moonlite_company.rewards.create!(:name => "$40 Apple Store Gift Card", :description => "Apple Store Gift Card worth 40 Dollars.", :image_url => "http://www.google.com", :points => 2000)
			moonlite_company.rewards.create!(:name => "1 Day of Payed-Time-Off", :description => "You've worked pretty hard. Take a day off on the company.", :image_url => "http://www.google.com", :points => 3000)
			moonlite_company.rewards.create!(:name => "2 Southwest Tickets", :description => "2 Roundtrip Southwest tickets to anywhere in the U.S.", :image_url => "http://www.google.com", :points => 10000)				
			moonlite_admin = User.create!(:name => "Admin User",
			...
			CompanyUser.create!(:company_id => moonlite_company.id,
				...
				:is_admin => true)
			moonlite_user = User.create!(:name => "Normal User",
			...
			5.times do |n|
				...
				moonlite_admin.paths.create!(:name => name, :description => description)
			end
